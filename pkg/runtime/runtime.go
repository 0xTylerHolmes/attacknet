...
//)
//
//func setupDevnet(ctx context.Context, cfg *types.ConfigParsed) (enclave *kurtosis.Service, err error) {
...
//	enclaveCtx, _, err := kurtosis.NewService(ctx, kurtosisCtx, cfg)
...
//}
//
//func loadEnclaveFromExistingDevnet(ctx context.Context, cfg *types.ConfigParsed) (enclave *kurtosis.Service, err error) {
//	kurtosisCtx, err := kurtosis.GetKurtosisContext()
//	if err != nil {
//		return nil, err
//	}
...
//	enclaveCtx, enclaveCreated, err := kurtosis.NewService(ctx, kurtosisCtx, cfg)
//	if err != nil {
//		return nil, err
//	}
//
...
//}
//
//func SetupEnclave(ctx context.Context, cfg *types.ConfigParsed) (enclave *kurtosis.Service, err error) {
